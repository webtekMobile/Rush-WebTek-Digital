...
<div class="row clearfix" style="height:10%;"></div>
      ...
      <div class="row ">
               <?php
                $q1="SELECT * FROM tbl_discount where vendor_id=$vid ";
               ...
               ?>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                   <a href="#pandey" aria-controls="pandey" class="active" role="tab" data-toggle="tab">
                    <div class="info-box bg-pink hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">ALL DISCOUNT PRODUCT</div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    ...
                    <div class="info-box bg-cyan hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">ADD NEW DISCOUNT</div>
                            <div class="number count-to" data-from="0" data-to="<?php echo $all;?>" data-speed="1000" data-fresh-interval="20"></div>
                        </div>
                    </div>
                </a>
        ...
        <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div role="tabpanel" class="body tab-pane fade in active" id="pandey">
                            ...
                            <?php
                                $query="SELECT * FROM tbl_discount where vendor_id=$vid";
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['start_date'];?></td>
                                               ...
                                               <td> <?php echo $row['end_date'];?></td>
                                                <td class="text-center" ><a class="btn btn-light" href="database/productdeletediscount.php?id=<?php echo $row['product_id']?>">
                                                 <i class="typcn icon typcn-delete-outline text-danger"></i>Remove </a>
                                                  </td>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="database/productdiscount.php" id="form_validation" method="POST" style="padding: 70px">
                                     <input type="hidden" name="vid" value="<?php echo $vid;?>">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" autocomplete="off" class="form-control" name="name" required >
                                        <label class="form-label" style="color:black">Offer Name</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" autocomplete="off" class="form-control" name="discount" required>
                                        <label class="form-label" style="color:black">Product Discount *</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <label class="form-label" style="color:black">Start Date *</label>
                                    <div class="form-line">
                                        <input type="date" autocomplete="off" class="form-control" name="sdate" required>
                                 ...
                                 <div class="form-group form-float">
                                    ...
                                    <div class="form-line">
                                        <input type="date" autocomplete="off" class="form-control" name="edate" required>
                            ...
                            <div class="collapse" id="collapseExample">
                                    ...
                                    $que="select * from tbl_add_product where vendor_id='$vid' ";
                                    $res=mysqli_query($con,$que);
                                    while ($result=mysqli_fetch_assoc($res)) {
                                      ?>

                                       <div class="form-group">
                                    <input type="checkbox" id="checkbox" name="pid" required value="<?php echo $result['product_id'];?>">
                                    <label for="checkbox"><?php echo $result['product_name'];?></label>
                                </div>
