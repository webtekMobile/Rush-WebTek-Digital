      ...
      <div class="row ">
               ...
               ?>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                       ...
                       <a href="merchant.php"  style="text-decoration: none ;">
                    <div class="info-box bg-pink hover-expand-effect">
                        <div class="icon">
                            <i class="material-icons">playlist_add_check</i>
                        </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    ...
                    <div class="info-box bg-cyan hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">ALL NEW PRODUCT</div>
                            <div class="number count-to" data-from="0" data-to="<?php echo $all;?>" data-speed="1000" data-fresh-interval="20"></div>
                        </div>
                    </div>
                </a>
                    ...
                    <div class="card">
                        ...
                        <!------------------------------->
                         <div role="tabpanel" class="body tab-pane fade in" id="pandey3">
                                 ...
                                 <div class="body">
                            <form action="#" id="form_validation" method="POST" style="padding: 70px" enctype="multipart/form-data">
                                <input type="hidden" name="vid" value="<?php  echo $vid;?>">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" autocomplete="off" class="form-control" name="fname" required >
                                        <label class="form-label" style="color:black">product_description</label>
                                    </div>
                                </div>
                               ...
                               <div class="form-group form-float">
                                    <div class="form-line">
                                        ...
                                        <label class="form-label" style="color:black">Add Ons</label>
                                    </div>
                                </div>

                                <div class="form-group form-float">
                                    <label class="form-label" style="color:black">product_price</label>
                                    <div class="form-line">
                                 ...
                                 <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="file" autocomplete="off" class="form-control" name="Password" required>
