               ...
               ?>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    ...
                    <div class="info-box bg-cyan hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">IN PROGRESS ORDERS</div>
                            <div class="number count-to" data-from="0" data-to="<?php echo $all;?>" data-speed="1000" data-fresh-interval="20"></div>
                        </div>
                    </div>
                </a>
                    ...
                    <div class="card">
                        ...
                        <div role="tabpanel" class="body tab-pane fade in active" id="pandey">
                             ...
                             <div class="body">
                                ...
                                <?php
                              $query="select * from tbl_orderbooking where order_status='pending' ";
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                                  ...
                                                  <td style="background: blue;text-align: center;color:white;">  <?php echo $row['order_status'];  ?></td>
                        ...
                        <div role="tabpanel" class="body tab-pane fade in" id="pandey2">
                             ...
                             <?php
                              $query="select * from tbl_orderbooking where order_status='inprogress' ";
                                $res=mysqli_query($con,$query);
                                $a=mysqli_num_rows($res);
                                if ($a > 0) 
                                {
                      ...
                      <?php
                              $query="select * from tbl_orderbooking where order_status='done' ";
                                $res=mysqli_query($con,$query);
                                $a=mysqli_num_rows($res);
                                if ($a > 0) 
                                {
