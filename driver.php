        ...
        <div class="row clearfix">
                            ...
                            ?>
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                                  <td><a href="driverprofile.php?id=<?php echo $row['driver_id'];?>" class="btn btn-success"><?php echo $row['driver_id'];?></a></td>
                                                  ...
                                                  <td>5</td>
                                                  <td> <a href="tel:<?php echo $row['driver_mobile'];?>" class="btn btn-danger"><i class="material-icons">perm_phone_msg</i></a></td>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="../database/addnewdriver.php" id="form_validation" method="POST" style="padding: 70px" enctype="multipart/form-data">
                               
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" autocomplete="off" class="form-control" name="name" required >
                                        <label class="form-label" style="color:black">Driver First Name</label>
                                    </div>
                                </div>
                               ...
                               <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" autocomplete="off" class="form-control" name="mobile" required >
                                        <label class="form-label" style="color:black">Driver Mobile Number</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        ...
                                        <label class="form-label" style="color:black">Driver Email</label>
                                    </div>
                                </div>
                                 ...
                                 <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" autocomplete="off" class="form-control" name="Password" required>
                                        <label class="form-label" style="color:black">Driver Password</label>
                                    </div>
                                </div>
                        ...
                        <div role="tabpanel" class="body tab-pane fade in" id="pandey2">
                            ...
                            <div class="row clearfix jsdemo-notification-button">
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4" >
                                    <img src="plugins/images/user.jpg" style="border-radius: 50%;">&nbsp;&nbsp;&nbsp;&nbsp;<strong><?php echo $row['driver_name'];?></strong>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <a href="../database/acceptnewdriverlist.php?id=<?php echo $row['driver_id'];?>" class="btn btn-success" style="border-radius: 50%">Accept</a>
                                <a href="../database/declinenewdriverlist.php?id=<?php echo $row['driver_id'];?>" class="btn btn-danger" style="border-radius: 50%">Decline</a>
                                </div>
