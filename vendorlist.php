      ...
      <div class="row ">
               ...
               ?>
                 <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a href="#pandey" aria-controls="pandey" role="tab" class="active" data-toggle="tab" style="text-decoration: none ;">
                    <div class="info-box bg-cyan hover-expand-effect">
                        <div class="icon">
                            <i class="material-icons">help</i>
                        </div>
                        <div class="content">
                            <div class="text">ALL VENDOR</div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        ...
                        <a href="#pandey2" aria-controls="pandey2" class="active" role="tab" data-toggle="tab"  style="text-decoration: none ;">
                    <div class="info-box bg-cyan hover-expand-effect">
                        <div class="icon">
                            <i class="material-icons">help</i>
                        </div>
                        <div class="content">
                            <div class="text">ADD VENDOR</div>
                            <div class="number count-to" data-from="0" data-to="<?php echo $all;?>" data-speed="1000" data-fresh-interval="20"></div>
                        </div>
                    </div>
                </a>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    ...
                    <div class="info-box bg-cyan hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">APPROVE VENDOR</div>
                            <div class="number count-to" data-from="0" data-to="<?php echo $all;?>" data-speed="1000" data-fresh-interval="20"></div>
                        </div>
                    </div>
                </a>
        ...
        <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                                  ...
                                                  <td style="background: red;color:white;text-align:center"><?php echo $row['status_vendor'];?></td>
                        ...
                        <div class="body">
                            <form action="../database/addvendor.php" id="form_validation" method="POST" style="padding: 70px" enctype="multipart/form-data">
                               
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" autocomplete="off" class="form-control" name="fname" required >
                                        <label class="form-label" style="color:black">Vendor First Name *</label>
                                    </div>
                                </div>
                                 ...
                                 <div class="form-group form-float">
                                    <div class="form-line">
                                        ...
                                        <label class="form-label" style="color:black">Vendor Last Name *</label>
                                    </div>
                                </div>
