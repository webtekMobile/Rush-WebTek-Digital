...
if(isset($_POST['sub_test']))
{
	...
	$sql="insert into tbl_subject(subject,date) values('$subject',curdate())";
	...
	<div class="col-lg-6" >
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body card-block">
                                                            <form action="subject.php" method="post" class="">
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                      
                                                                        <input type="text" id="subject" name="sub" class="form-control" required>
                                                                        <div class="input-group-addon"><i class="fa fa-user"></i></div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-actions form-group">
                                                                    <button type="submit" class="btn btn-primary btn-sm" name="sub_test">Submit</button>
                                                                </div>
                                                            </form>
		...
		<?php
		$sub_sql="select * from tbl_subject";
		$res_sub=mysqli_query($conn,$sub_sql);?>
		...
		$sub=$row_sub['subject'];
		?>
			<button class="accordion"> <h3><?php echo $sub;  ?></h3></button>
			<?php
		}
		?>
		<div class="panel">   ]h
		...
		?>
            <p>
               <a href="level.php?level=<?php echo $i;  ?>&subject=<?php echo $sub;  ?>">level<?php echo $i;   ?>
            </p>
...
function multi()
{
	var multi=document.getElementsByClassName("accordion");
