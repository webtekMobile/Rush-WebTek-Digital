...
@$msg=decryptString($_REQUEST['msg']);
@$ide=$_REQUEST['ide'];
if($ide=="")
{
}
...
{
$id_query="delete from tbl_interview where interview_id='$ide'";
...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
         	...
         	<div class="col-lg-12">
                                                    <div class="card">
                                                        <div class="card-header">View Interviewquestion</div>
													...
													$query_view="select * from tbl_interview where consult_id='$c_id'";
														...
														<tr>
														<td><?php echo $a; ?></td>
														<td><?php $sub=$row_view['subject_id'];
$sub_query="select * from tbl_subject where subject_id='$sub'";
$sub_res=mysqli_query($conn,$sub_query);
if($sub_row=mysqli_fetch_array($sub_res,MYSQLI_BOTH))
{
	echo $sub_row['subject'];
														...
														<td><?php  echo $row_view['interview'];  ?></td>
														<td><?php  echo $row_view['date'];  ?></td>
														<td><a href="viewinterview.php?ide=<?php echo $row_view['interview_id'];  ?>"><i class="fa fa-trash"></i></a></td>
														<td><a href="updateinterview.php?ide=<?php echo encrypString($row_view['interview_id']);  ?>"><i class="fa fa-edit"></i></a></td>
														<td><a href="interviewstatus.php?id=<?php echo $row_view['interview_id'];  ?>">
														<?php
														if($row_view['status']=='false')
														{
