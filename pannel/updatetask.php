...
if(isset($_POST['sub_task']))
{
	...
	@$task=isset($_POST['editor'])?$_POST['editor']:"";
	@$filename=$_FILES['file']['name'];
	@$filesize=$_FILES['file']['size'];
	@$filetype=$_FILES['file']['type'];
	@$tmp_name=$_FILES['file']['tmp_name'];
	@$location="upload/";
	$qr=mysqli_query($conn,"select * from tbl_task where task_id='$ide'");
if($roq=mysqli_fetch_array($qr,MYSQLI_BOTH))
{
	//$subject=$roq['subject'];
	$filename=$roq['upload_task'];
	
}
mysqli_query($conn,"update tbl_task set subject_id='$subject',consult_id='$cid',task='$task',upload_task='$filename' where task_id='$ide'");
header("Location:viewtask.php");
}
$rs=mysqli_query($conn,"select * from tbl_task where task_id='$ide'");
													...
													<form action="#" method="post" enctype="multipart/form-data">
                                                        <div class="card-header"><b><h3>Topic</h3></b><br/>											
														 <div class="form-group">
																	...
																	<?php
																	$sub=$rows['subject_id'];
echo $sql1="select * from tbl_subject where subject_id='$sub'";
...
?>
														...
														<br/>
<div class="form-grup">														
                                                                        <input type="file" id="file" name="file" value='<?php  $rows['upload_task'];  ?>' >
