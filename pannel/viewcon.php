...
@$ide=$_GET['ide'];
$id_query="delete from tbl_content where content_id='$ide'";
...
<?php
	if($con=='success')
{
	echo "<script>swal('Update Successfully','success');
	window.location.href='viewcon.php';</script>";
}
	?>
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="adm_profile.php"><i class="fa fa-user"></i> My Profile</a>
        ...
        <div class="content mt-3">
         	...
         	<div class="col-lg-12">
                                                    <div class="card">
                                                        <div class="card-header"><h2>View Content</h2>
													
														<br/>
														<select class="form-control" name='conco'  onchange="conco()" id='cono'>
														<option value="">---select here---</option>
														<?php
														$bran=$_SESSION['branch'];
														$rt=mysqli_query($conn,"select * from tbl_subject where branch='$bran'");
														
														while($rit=mysqli_fetch_array($rt,MYSQLI_BOTH))
														{
														?>
														<option value='<?php  echo $rit['subject_id'];  ?>' ><?php  echo $rit['subject']; ?></option>
														<?PHP
														}
														...
														$query_con="select * from tbl_content where consult_id='$c_id'";
														$res_view=mysqli_query($conn,$query_con);
														$a=1;
														...
														<td><?php  echo $row_view['topic_inner'];  ?></td>
														
														<td><?php  echo $row_view['date'];  ?></td>
														<td><a href="viewcon.php?ide=<?php echo $row_view['content_id'];  ?>"><i class="fa fa-trash"></i></a></td>
														<td><a href="updatecontent.php?ide=<?php echo $row_view['content_id'];  ?>"><i class="fa fa-edit"></i></a></td>
														<td><a href="constatus.php?id=<?php echo $row_view['content_id'];  ?>">
														<?php
														if($row_view['status']=='true')
														{
															
															echo "<i class='fa fa-user' style='color:black'></i>";
															//echo "<script>window.location.href='viewcon.php';</script>";
														}
														else
														{
															
																echo "<i class='fa fa-user' style='color:red'></i>";
															//	echo "<script>window.location.href='viewcon.php';</script>";
														}
														?>
														...
														$query_con1="select * from tbl_content where subject_id='$cont'";
														$res_view1=mysqli_query($conn,$query_con1);
														$a=1;
														while($row_view1=mysqli_fetch_assoc($res_view1))
														{
														?>
														<tr>
														<td><?php echo $a; ?></td>
														
														<td><?php  echo $row_view1['topic'];  ?></td>
														<td><?php  echo $row_view1['topic_inner'];  ?></td>
														<td><?php  echo $row_view1['date'];  ?></td>
														<td><a href="viewcon.php?ide=<?php echo $row_view1['content_id'];  ?>"><i class="fa fa-trash"></i></a></td>
														<td><a href="updatecontent.php?ide=<?php echo $row_view1['task_id'];  ?>"><i class="fa fa-edit"></i></a></td>
														<td><a href="constatus.php?id=<?php echo $row_view1['content_id'];  ?>">
														<?php
														if($row_view1['status']=='false')
														{
  ...
  function conco()
  {
	  var con=document.getElementById('cono').value;
	  window.location.href='viewcon.php?cont='+con;
  }
  </script>
