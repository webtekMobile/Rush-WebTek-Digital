...
{
$id_query="delete from tbl_task where task_id='$ide'";
        ...
        <div class="content mt-3">
         	...
         	<div class="col-lg-12">
                                                    <div class="card">
														...
														<td><?php  echo $row_view['task'];  ?></td>
														<td><?php  echo $row_view['upload_task'];  ?></td>
														<td><?php  echo $row_view['date'];  ?></td>
														<td><a href="viewtask.php?ide=<?php echo $row_view['task_id'];  ?>"><i class="fa fa-trash"></i></a></td>
														<td><a href="updatetask.php?ide=<?php echo encrypString($row_view['task_id']);  ?>"><i class="fa fa-edit"></i></a></td>
														<td><a href="taskstatus.php?id=<?php echo $row_view['task_id'];  ?>">
														<?php
