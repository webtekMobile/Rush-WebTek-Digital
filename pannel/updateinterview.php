...
{
	$cid=$row_query['consult_id'];
}
if(isset($_POST['sub_task']))
{
	@$subject=isset($_POST['subject'])?$_POST['subject']:"";
	@$interview=isset($_POST['editor'])?$_POST['editor']:"";
	@$filename=$_FILES['file']['name'];
	@$filesize=$_FILES['file']['size'];
	@$filetype=$_FILES['file']['type'];
	@$tmp_name=$_FILES['file']['tmp_name'];
	@$location="upload/";
	$qr=mysqli_query($conn,"select * from tbl_interview where interview_id='$ide'");
if($roq=mysqli_fetch_array($qr,MYSQLI_BOTH))
{
	//$subject=$roq['subject'];
	if($filename=="")
	{
...
mysqli_query($conn,"update tbl_interview set subject_id='$subject',consult_id='$cid',interview='$interview',file='$filename' where interview_id='$ide'");
header("Location:viewinterview.php");
}
$rs=mysqli_query($conn,"select * from tbl_interview where interview_id='$ide'");
if($rows=mysqli_fetch_array($rs,MYSQLI_BOTH))
{
?><!doctype html>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="<?php echo $_SESSION['photo'];  ?>" alt="User Avatar">
                        </a>
													...
													<form action="#" method="post" enctype="multipart/form-data">
                                                        <div class="card-header"><b><h3>Topic</h3></b><br/>											
														 <div class="form-group">
																	...
																	<?php
																	$sub=$rows['subject_id'];
$sql1="select * from tbl_subject where subject_id='$sub'";
...
?>
														...
														<br/>
<div class="form-grup">														
                                                                        <input type="file" id="file" name="file" value='<?php  $rows['file'];  ?>' >
                                                        ...
                                                        <div class="card-body card-block">
																...
																<h2>interview:-</h2><br/>
																	...
																	<br/>
																	<br/>
																	<input type="submit" name="sub_task" value="Update"/>
