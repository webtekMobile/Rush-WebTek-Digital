...
{
		$topic=isset($_POST['subject'])?$_POST['subject']:"";
		$in_question=isset($_POST['editor'])?$_POST['editor']:"";
		$file=isset($_FILES['file']['name'])?$_FILES['file']['name']:"";
		$tmp_name=isset($_FILES['file']['tmp_name'])?$_FILES['file']['tmp_name']:"";
		if($topic=="")
		{
			echo "<script>alert('Please select topic');</script>";
		}
		else
		{
			$ins_query="insert into tbl_interview(consult_id,subject_id,file,interview,date) values('$consult_id','$topic','$file','$in_question',curdate())";
...
<input type="hidden" name="consult" value="<?php echo $consult_id;  ?>"/>
																...
																<h4>Upload Your Interviewquestion
<input type="file" name="file"/>																												
                                                        ...
                                                        <div class="card-body card-block">
                                                                ...
                                                                <div class="form-group">
																<h2>Interview question:-</h2><br/>
                                                                    <div class="input-group">
                                                                      
                                                                         <textarea name="editor" id="editor" rows="10" cols="80" placeholder="Write Something........">
																	...
																	<br/>
																	<br/>
																	<input type="submit" name="sub_inter"/>
