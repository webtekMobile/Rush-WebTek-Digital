...
if(isset($_POST['change_pass']))
{
		...
		$sql="select * from tbl_consultant where email='$email'";
		...
		if($row=mysqli_fetch_assoc($res))
		{
			...
			if($op==$pp)
			{
				...
				{
					?>
				<script>alert("new password is  not matched by your old password");</script>
				<?php
				}
				else 
				{
					if($np==$cnp)
				{
					$sql_pass="update tbl_consultant set password='$cnp' where email='$email'";
				...
				{
					?>
				<script>alert("new password is  not matched by your confirm new password");</script>
			<?php
			...
			{
				?>
				<script>alert("password is  not matched by your old password");</script>
			<?php
			}
		}
}
                                                            ...
                                                            <form action="" method="post" class="">
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        <input type="password" id="op" name="op" placeholder="Old Password" class="form-control">
                                                                        <div class="input-group-addon"><i class="fa fa-lock"></i></div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        <input type="password" id="np" name="np" placeholder="New Password" class="form-control">
                                                                        <div class="input-group-addon"><i class="fa fa-lock"></i></div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        <input type="password" id="cnp" name="cnp" placeholder="Confirm New Password" class="form-control">
                                                                        <div class="input-group-addon"><i class="fa fa-lock"></i></div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-actions form-group"><button type="submit" class="btn btn-secondary btn-sm" name="change_pass">Change</button></div>
                                                            </form>
                                                        </div>
                                                    </div>
                                                </div>
