...
<body>
	...
	<div class="card" style="width:100%;">
                                                        ...
                                                        <div class="card-body card-block" >
                                                            <form action="subject.php" method="post" class="" style="width:100%;">
															<input type="text"/>
															<button></button>
                                                            </form>
	...
	<div class="card" style="width:100%;">
                                                ...
                                                <textarea name="editor" id="editor" rows="30" cols="100" style="resize:none;">
        Write Something..
                                                  </textarea>
                                                            </form>
													...
													<div class="card" style="width:100%;">
                                                        ...
                                                        <div class="card-body card-block" >
                                                            <form action="subject.php" method="post" class="" style="width:100%;">
															<div id="radio" style="height:10px;width:10px;border:1px solid;">
															<label for="option"><input type="radio"/></label>
