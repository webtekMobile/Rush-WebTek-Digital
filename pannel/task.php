...
$consult=$_SESSION['consultant'];
@$qu=$_REQUEST['qu'];
if($qu==1)
{
	echo "<script>alert('Task Upload Successfully');
	window.location.href='task.php';</script>";
}

$con_query="select * from tbl_consultant where email='$consult'";
$res_con=mysqli_query($conn,$con_query);
if($row_con=mysqli_fetch_array($res_con,MYSQLI_BOTH))
{
	$trainer_id=$row_con['0'];
}
if(isset($_POST['sub_task']))
{
	...
	@$location="upload/";
				$sql_query="insert into tbl_task(subject_id,consult_id,task,upload_task,status,date) values('$subject','$trainer_id','$task','$filename','false',curdate())";		
		mysqli_query($conn,$sql_query);
		move_uploaded_file($tmp_name,$location.$filename);
		header("Location:task.php?qu=1");
...
<?php echo $_SESSION['consultant'];   ?>
	...
	<div class="col-lg-12" >
													...
													<form action="#" method="post" enctype="multipart/form-data">
                                                        <div class="card-header"><p><b><h3>Task topic</h3></b>						  <input type="file" id="file" name="file"  class="file" style="margin-left:70%;">
														</p>
<br/>													
...
$sql1="select * from tbl_subject where branch='$bran'";
...
<?php
$sql_query="select * from tbl_consultant";
...
?>
                                                        ...
                                                        <div class="card-body card-block">
																...
																<h2>Task:-</h2><br/>
																	...
																	<br/>
																	<br/>
																	<input type="submit" name="sub_task"/>
