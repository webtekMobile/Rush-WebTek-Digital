...
@$ide=$_GET['id'];
$ide_sql="select * from tbl_content where content_id='$ide'";
$ide_res=mysqli_query($conn,$ide_sql);
if(isset($_POST['up_con']))
{
		...
		$sql="update tbl_content set subject_id='$subject',topic='$content',topic_inner='$editor',file='' where content_id='$con_id'";
...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="widgets.html"> <i class="menu-icon ti-email"></i>Show </a>
                    </li>
                    <li class="menu-item-has-children dropdown">
                    ...
                    <h3 class="menu-title">Show</h3><!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown">
    ...
    <div id="right-panel" class="right-panel">
		...
		<?php   
		if($ide_row=mysqli_fetch_assoc($ide_res))
		{
...
?>
               ...
               <select onchange="subj()" name="subject" id="sub">
			   <option value="<?php echo $ide_row['suject_id'];?>"><?php $ide_subject=$ide_row['subject_id'];
			   $sql3="select * from tbl_subject where subject_id='$ide_subject'";
$res_query3=mysqli_query($conn,$sql3);
if($row_query3=mysqli_fetch_assoc($res_query3))
{
	
echo $row_query3['subject'];
}		   
			   ?></option>
															   <?php
...
?>
 ...
 <input type="text" id="content" name="con" value="<?php echo $ide_row['topic'];?>" class="form-control" required>
 <input type="hidden"  name="con_id" value="<?php echo $ide_row['content_id'];?>" class="form-control" required>
												                                                                       
                                                                    </div>
                                                                </div>
																<h4>Upload Your Content
