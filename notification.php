...
<div class="row clearfix" style="height:10%;"></div>
     ...
     <div class="row ">
               <?php
                $q1="SELECT * FROM tbl_notification ";
               ...
               ?>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                      <a href="#pandey1" aria-controls="pandey1" role="tab" data-toggle="tab"  style="text-decoration: none ;">
                    ...
                    <div class="info-box bg-cyan hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">ADD NOTIFICATION</div>
                            <div class="number count-to" data-from="0" data-to="<?php echo $all;?>" data-speed="1000" data-fresh-interval="20"></div>
                        </div>
                    </div>
              </a>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                   <a href="#pandey3" aria-controls="pandey3" role="tab" data-toggle="tab"  style="text-decoration: none ;">
                    <div class="info-box bg-light-green hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">APPROVE NOTIFICATION </div>
                            <div class="number count-to" data-from="0" data-to="<?php echo $all;?>" data-speed="1000" data-fresh-interval="20"></div>
                        </div>
                    </div>
                  </a>
         ...
         <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <?php
                                $query="select * from tbl_notification where notification_status='1' ";
                            ...
                            <div class="row clearfix jsdemo-notification-button">
                                <div class="col-xs-12 col-sm-6 col-md-5 col-lg-5" >
                                    <img src="plugins/images/user.jpg" style="border-radius: 50%;">&nbsp;&nbsp;&nbsp;&nbsp;<strong>CARLA ABBOUD</strong>
                                </div>
                    ...
                    <!------------add notification----->
                        ...
                        <div role="tabpanel" class="body tab-pane fade in" id="pandey1">
                        <div class="body">
                            ...
                            <div class="collapse" id="collapseExample">
                                    ...
                                    $que="select * from tbl_add_product ";
                ...
                <!----------------approve notification--->
                   ...
                   <div role="tabpanel" class="body tab-pane fade in" id="pandey3">
                        <div class="body">
                            <?php
                                 $query="select * from tbl_notification where notification_status='0' ";
                                $res=mysqli_query($con,$query);
                                $a=mysqli_num_rows($res);
                                if ($a > 0) 
                                {
                            ...
                            <div class="row clearfix jsdemo-notification-button">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <a href="../database/acceptnotification.php?id=<?php echo $row['notification_id'];?>" class="btn btn-success" style="border-radius: 50%">Accept</a>
                                <a href="../database/declinenotification.php?id=<?php echo $row['notification_id'];?>" class="btn btn-danger" style="border-radius: 50%">Decline</a>
                                </div>
