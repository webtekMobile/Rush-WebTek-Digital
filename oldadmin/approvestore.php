                   ...
                   <div class="row">
                    <div class="col-sm-12">
                     ...
                     <?php 
                      ...
                      <div class="row">
                      <div class="col-sm-3">
                        <img src="../img/faces/face1.jpg" alt="admin-image" class="rounded-circle img-fluid" style="border-radius:50%;">&nbsp;<strong><?php echo $data['vendor_fname'];?></strong>
                      </div>
                      <div class="col-sm-3">
                        <p style="padding: 15px">
                       <strong><?php echo $row['shop_name'];?></strong>
                    </p>
                      </div>
