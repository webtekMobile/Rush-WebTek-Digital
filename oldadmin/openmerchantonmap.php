              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="row grid-margin">
                    <div class="col-12">
                      <a href="allstore.php?id=<?php echo $vid;?>" class="btn btn-success">Store</a>
                      <a href="openmerchantonmap.php?id=<?php echo $vid;?>" class="btn btn-success">Map</a>
...
include('../database/connect.php');
 ...
 $query="select * from tbl_shop where vendor_id='$vid' ";
...
center: new google.maps.LatLng( <?php echo $row['shop_latitude']?>, <?php echo $row['shop_longitude']?> ),
// center : {
// lat: -34.397,
// lng: 150.644
// },
