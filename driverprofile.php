                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix jsdemo-notification-button">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4" >
                                    <h3><u>PROFILE PICTURE</u></h3>
                                    <br>
                                    <img src="plugins/images/user.jpg">
                                </div>
                                  
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4" style="    border-right: 1px solid;border-left: 1px solid;">
                                    <h3><u>GENERAL INFO</u></h3>
                                    <br>
                                    <strong>Full Name *</strong><br>
                                    <br>
                                  <p  style="padding: 15px;background: coral"><?php echo $row['driver_name'];?></p>
                                  <br>
                                  <br>
                                  <strong>Email address *</strong><br><br>
                                 <p  style="padding: 15px;background: coral"> <?php echo $row['driver_email'];?></p>
                                  <br>
                                  <br>
                                  <strong>Phone number *</strong><br>
                                  <br>
                                  <p  style="padding: 15px;background: coral"><?php echo $row['driver_mobile'];?></p>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                    <h3><u>ACTION</u></h3>
                                    <br>
                                 <a href="" class="btn btn-danger">Remove driver</a>
                                </div>
